...
str1 = '<table width="85%"  border="0">';
str1 += '<tr><td width="28%" height="247" rowspan="9"><img src="images/aiot_logo2.gif" width="113" height="201"></td><td width="42%" height="30" class="nav style26">Section</td><td width="30%" class="nav style26">Score</td></tr>';
...
str1 += '<tr><td height="47" colspan="2" class="Verdana12bold"><div align="center" id="printlogo">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="Submit" value="Print Scores" onClick="getScore();"></div></td></tr></table>';
...
function getScore()
{
		window.location.replace("scoreInfo.htm");
}
...
if(opener.totalScore >= 1)
{
	...
	str1 = str1 + '<br /><div align="center" id="printlogo1" class="Verdana12bold">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Click here to get your certificate <br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="Get Certificate" onClick="getCertificate()"></div>';
}
